...
import dev.davletshin.intouch.service.props.JwtProperty;
...
public class JwtTokenProvider {
    ...
    public String createAccessToken(UUID user_id, String username, Set<Role> roles) {
    ...
    public String createRefreshToken(UUID user_id, String username) {
        Claims claims = Jwts.claims()
                .subject(username)
                .add("id", user_id)
                .build();
